...
execute if score #{score} {namespace}.settings matches 0 run tellraw @s [{'{"color":"white","text":"'+desc_default[0]+'"}'},{'{"clickEvent":{"action":"run_command","value":"/function '+namespace+':v'+version+'/update_config {\\\"value\\\":1, \\\"param\\\":\\\"'+score+'\\\"}"}'},"color":"green","hoverEvent":{'{"action":"show_text","value":[{"text":"Dea'+desc_default[1]+'"}]},"text":"[x]"}'}]
