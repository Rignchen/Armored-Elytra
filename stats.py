...
print("advancements:" + str(surch(["json"],"data/elytrarmor/advancements")) + " (display: " + str(surch(["json"],"data/elytrarmor/advancements/display")) + ")")
print("functions:" + str(surch(["mcfunction"],"data/elytrarmor/functions",max_linie,[])) + " (bigest: " + str(maxi) + " (" + bigest + "), total commands: " + str(total) + ")")
print("predicates:" + str(surch(["json"],"data/elytrarmor/predicates")))
print("plugin:" + str(surch(["json"],"data/elytrarmor/tags/functions")))
