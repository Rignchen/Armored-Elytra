#execute as player at crafter when craft leather elytra (> elytrarmor/function/action/craft)

#plugin
function #elytrarmor:craft

#put into the storage
data modify storage elytrarmor elytra set from block ~ ~ ~ Items[{id:"minecraft:leather_chestplate"}].tag

#remove the armor
data remove block ~ ~ ~ Items[{id:"minecraft:leather_chestplate"}]
