...
data modify storage elytrarmor:data armor set from block ~ ~ ~ Items[{id:"minecraft:chainmail_chestplate"}].tag

# Start of the craft
function elytrarmor:action/craft/craft_start

# Data
execute unless data storage elytrarmor:data armor.display.Name run data modify storage elytrarmor:data armor.display.Name set value '{"text":"Chain Elytra","italic":false}'
...
data modify storage elytrarmor:data armor.CustomModelData set value 537292
