...
#reset the elytra
data remove storage elytrarmor:data elytra.tag.CustomModelData
data remove storage elytrarmor:data elytra.tag.Enchantments
data remove storage elytrarmor:data elytra.tag.display
data remove storage elytrarmor:data elytra.tag.AttributeModifiers
data remove storage elytrarmor:data elytra.tag.Tags
